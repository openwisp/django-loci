...
DJANGO_LOCI_GEOCODE_STRICT_TEST = getattr(settings, 'DJANGO_LOCI_STRICT_GEOCODE_TEST', True)
DJANGO_LOCI_GEOCODE_FAILURE_DELAY = getattr(settings, 'DJANGO_LOCI_GEOCODE_FAILURE_DELAY', 1)
DJANGO_LOCI_GEOCODE_RETRIES = getattr(settings, 'DJANGO_LOCI_GEOCODE_RETRIES', 3)
DJANGO_LOCI_GEOCODE_API_KEY = getattr(settings, 'DJANGO_LOCI_GEOCODE_GOOGLE_API_KEY', None)
