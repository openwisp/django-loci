...
<https://docs.djangoproject.com/en/5.2/ref/contrib/gis/>`_:

- `Geospatial libraries
  <https://docs.djangoproject.com/en/5.2/ref/contrib/gis/install/geolibs/>`_
- `Spatial database
...
<https://docs.djangoproject.com/en/5.2/ref/contrib/gis/db-api/#spatial-backends>`_.
